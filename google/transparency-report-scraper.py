...
def scrape(advertiserId):
    ...
    with webdriver.Chrome(options=options) as driver:
        ...
        adTexts = [ad.getText().replace(',','') for ad in ads]
    return adTexts
...
def csv_scrape():
    ...
    advertiser_ids = [id for id in df['Advertiser_ID'].tolist()[61:150]] # paginate through advertiser IDs
    print("num advertisers = ", len(advertiser_ids))
    scrape_advertisers(advertiser_ids, False)
